...
use \MessageBoy\Interfaces\MessageDispatcherInterface;
...
class MessageDispatcher implements MessageDispatcherInterface
{
     ...
     * @return int
     */
    public function dispatch(MessageInterface $message, $type = null, $group = null)
    {
        $dispatched = 0;
        if (!$type && !$group) {
     ...
     */
    public function registerAdapter(AdapterInterface $adapter, $type = null, $group = null)
    {
